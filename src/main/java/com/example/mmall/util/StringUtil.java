...
//		stringBuilder.append("\t\t\tsb.append(getClass().getSimpleName());").append("\r");
	...
	/**
	 * 验证一个字符串是否是符合手机格式，当字符串为空时也返回false.
	 *
	 * @author WuShuicheng .
	 * @param str
	 *            要判断的字符串 .
	...
	/**
	 * 验证一个字符串是否是符合邮箱格式，当字符串为空时也返回false.
	 *
	 * @author WuShuicheng .
	 * @param str
	 *            要判断的字符串 .
	...
	public static boolean isEmail(String str) {
		if (StringUtils.isBlank(str) || null == str || str.length() == 0) {
			return false;
		} else {
...
//		System.out.println(generateFormString("alipays://platformapi/startapp?saId=10000007&clientVersion=3.7.0.0718&qrcode=https://qr.alipay.com/bax08094fcant8a3bqg7602c?_s=web-other" , "post" ,  parma , "utf-8"));
		//System.out.println(get32UUID());


		System.out.println(isPhone("11111111112"));
		//System.out.println(isEmail("11111qq.com"));
	}
