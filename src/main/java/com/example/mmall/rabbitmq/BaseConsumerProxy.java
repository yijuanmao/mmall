...
import com.example.mmall.common.constants.CommonConst;
...
public class BaseConsumerProxy {
    ...
    public Object getProxy() {
        ...
        Object proxy = Proxy.newProxyInstance(classLoader, interfaces, (proxy1, method, args) -> {
            ...
            try {
                ...
                msgLogService.updateStatus(correlationId, CommonConst.CONSUMED_SUCCESS);
    ...
    private boolean isConsumed(String correlationId) {
        ...
        if (null == msgLog || msgLog.getStatus().equals(CommonConst.CONSUMED_SUCCESS)) {
            return true;
        }
